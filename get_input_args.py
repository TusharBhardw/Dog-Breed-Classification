...
def get_input_args():
    ...
    parser.add_argument('--arch', default = 'vgg',type = str,help ="Select the classifier architecture" )
    parser.add_argument('--dogfile', default ='dognames.txt',type = str,help ="Select the classifier architecture" )
